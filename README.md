...
<ul>
  <li><h3>1.</h3> Необходимо загрузить на компьютер файлы проекта</li>
  ...
  <li><h3>2.</h3> Необходимо развернуть проект</li>
  ...
  <li><h3>3.</h3> Далее, после запуска сервера, приложение должно работать.</li>
</ul>
